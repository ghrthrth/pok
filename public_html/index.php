...
::-webkit-scrollbar-thumb {
    ...
    <title><?=$titl;?></title>
    <meta name="description" content="Pokezone - Браузерная онлайн игра по миру покемонов!" />
...
VK.Widgets.CommunityMessages("vk_community_messages", 164378292, {widgetPosition: "left",disableExpandChatSound: "1",tooltipButtonText: "Есть вопрос? Задай!"});
</script>
                        ...
                        <table width="440" height="23" border="1" align="center" cellspacing="0" background="/img/menu.jpg" style="border:1px solid #FFF;">
                            <tr>
                                <td><div align="center" style='font-size:11px;'>
                                      ...
                                      | <a href="https://claimbe.store/" target="_blank">Форум</a></div>
                                </td>
                            </tr>
                        </table>
                                ...
                                <td>
                                    ...
                                    <form name="а1" action="login.php" method="post">
                                        <table border="0">
                                            <tr>
                                                <td>Логин:</td>
                                                <td><input name='uName' type='text' size='15' value=""><br></td>
                                            </tr>
                                            <tr>
                                                <td>Пароль:</td>
                                                <td>
...
<!-- /HotLog -->
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <br>
                                      <a href="https://vk.com/mmorpgpokemon" target="_blank"><img src='https://claimbe.ru/img/iconvk.png'border='0'></a>
                                    <a href="https://www.youtube.com/channel/UCNdVH2FegN280ci6ZtCHZ3A" target="_blank"><img src='https://claimbe.ru/img/iconyoutube.png' border='0'></a>
                                 <a href="https://discord.gg/bfQKbyM" target="_blank"><img src='https://claimbe.ru/img/icondis.png' border='0'></a>                                  
                                 <a href="https://t.me/Pokezone" target="_blank"><img src='https://claimbe.ru/img/teleg.png' border='0'></a>   
                                </td>
                            </tr>
                            <!-- <tr>
                            ...
                            <tr>
                                <td align='center'>
                                    <p><strong><a href="http://forum.claimbe.ru/viewforum.php?f=3" target="_blank">Официальные турниры </a></strong></p>
                                    <p><b>Неофициальный турнир: Предновогоднее настроение! Успей урвать первые праздничные подарки.</b><strong><a href="http://forum.claimbe.ru/viewtopic.php?f=6&t=178" target="_blank"> Подробнее </a></strong></p> 
                                    <p><b>Кокурс Тутт-Фрутти 11.05.2020 по 30.05.2020</b><strong><a href="http://forum.claimbe.ru/viewtopic.php?f=37&t=41" target="_blank"> Подробнее </a></strong></p> 
                                </td>
                            </tr>-->
                            <tr>
                                <td class="title" style="text-align:center;"><font color="Red"><b>Little News</b></font></td>
                            </tr>
                            <tr>
                                <td>
<?php
...
?>
                                    <tt><font color=green>[<?=$nm['date'];?>]</font></tt>
                                    </a><?=$nm['text'];?><br>
<?php } ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align='center'>
                                    ...
                                    в Discord</a></b>
                                    <br>
                                    <!-- <b><a href="https://forum.claimbe.ru/viewtopic.php?f=5&p=2399&sid=8ede3f73a88fc47354d4f30b92942441#p2399" target="_blank"><?=$titl?>   Турнир для новичков августа</a></b> 
                                    <br>
                                    <b><a href="https://forum.claimbe.ru/viewtopic.php?f=5&t=1226" target="_blank"><?=$titl?>   Турнир для неопытных августа</a></b> 
                                    <br>
                                    <b><a href="https://forum.claimbe.ru/viewtopic.php?f=5&t=1224" target="_blank"><?=$titl?>   Открытый турнир августа</a></b>  -->
                                    <!--
...
?>
                                            <tr>
                                                <td width='10'>&nbsp;</td>
                                                <td class='bottom_dot'>
                                                    <a href='/game.php?fun=treninf&to_id=<?=$rangs['id'];?>' onclick="window.open('/game.php?fun=treninf&to_id=<?=$rangs['id'];?>', 'treninf', 'fullscreen=no,scrollbars=yes,width=500,height=430'); return false;"><? if($rangs['sex'] == 'male'){ ?><img src='http://claimbe.ru/img/question.gif' border='0'><?}else{?><img src='http://claimbe.ru/img/question_fem.gif' border='0'><?}?></a>
...
?>
                                                <tr>
                                                    <td width='10'>&nbsp;</td>
                                                    <td class='bottom_dot'>
                                                        <a href='/game.php?fun=treninf&to_id=<?=$topPok['id'];?>' onclick="window.open('/game.php?fun=treninf&to_id=<?=$topPok['id'];?>', 'treninf', 'fullscreen=no,scrollbars=yes,width=500,height=430'); return false;"><? if($topPok['sex'] == 'male'){ ?><img src='http://claimbe.ru/img/question.gif' border='0'><?}else{?><img src='http://claimbe.ru/img/question_fem.gif' border='0'><?}?></a></a>
...
?>
                                                <tr>
                                                    <td width='10'>&nbsp;</td>
                                                    <td class='bottom_dot'>
                                                        <a href='/game.php?fun=treninf&to_id=<?=$topShinePok['id'];?>' onclick="window.open('/game.php?fun=treninf&to_id=<?=$topShinePok['id'];?>', 'treninf', 'fullscreen=no,scrollbars=yes,width=500,height=430'); return false;"><? if($topShinePok['sex'] == 'male'){ ?><img src='http://claimbe.ru/img/question.gif' border='0'><?}else{?><img src='http://claimbe.ru/img/question_fem.gif' border='0'><?}?></a></a>
...
?>
                                                <tr>
                                                    <td width='10'>&nbsp;</td>
                                                    <td class='bottom_dot'>
                                                        <a href='/game.php?fun=treninf&to_id=<?=$ta['id'];?>' onclick="window.open('/game.php?fun=treninf&to_id=<?=$ta['id'];?>', 'treninf', 'fullscreen=no,scrollbars=yes,width=500,height=430'); return false;"><? if($ta['sex'] == 'male'){ ?><img src='http://claimbe.ru/img/question.gif' border='0'><?}else{?><img src='http://claimbe.ru/img/question_fem.gif' border='0'><?}?></a></a>
...
?>
                                    <tt><font color=green>[<?=$cl['date'];?>]</font></tt>
...
?>
                                    <tt><font color=green>[<?=$cl['data'];?>]</font></tt>
                                    <a href='/game.php?fun=treninf&to_id=<?=$cl["user"];?>' onclick="window.open('game.php?fun=treninf&to_id=<?=$cl["user"];?>', 'treninf', 'fullscreen=no,scrollbars=yes,width=500,height=430'); return false;"><? if($usr['sex'] == 'male'){ ?><img src='http://claimbe.ru/img/question.gif' border='0'><?}else{?><img src='http://claimbe.ru/img/question_fem.gif' border='0'><?}?></a></a>
                                    <b><?=$usr['login'];?></b>:
