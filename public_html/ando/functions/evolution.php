...
function Evolution($pok, $population)
{
  ...
  if ($pok['basenum'] == 731 and $pok['lvl'] >= 14) {
    $n_nom = 732;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 732 and $pok['lvl'] >= 28) {
    $n_nom = 733;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 734 and $pok['lvl'] >= 20) {
    $n_nom = 735;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 736 and $pok['lvl'] >= 20) {
    $n_nom = 737;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 737 and $user['location'] == 131) {
    $n_nom = 738;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 739 and $user['location'] == 89) {
    $n_nom = 740;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 742 and $pok['lvl'] >= 25) {
    $n_nom = 743;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 744 and $pok['lvl'] >= 25) {
    $n_nom = 745;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 751 and $pok['lvl'] >= 22) {
    $n_nom = 752;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 753 and $pok['lvl'] >= 34) {
    $n_nom = 754;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 761 and $pok['lvl'] >= 18) {
    $n_nom = 762;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 767 and $pok['lvl'] >= 30) {
    $n_nom = 768;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 782 and $pok['lvl'] >= 35) {
    $n_nom = 783;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 783 and $pok['lvl'] >= 45) {
    $n_nom = 784;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 789 and $pok['lvl'] >= 43) {
    $n_nom = 790;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 803 and ($pok['atk1'] == 406 or $pok['atk2'] == 406 or $pok['atk3'] == 406 or $pok['atk4'] == 406)) {
    $n_nom = 804;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 852 and ($pok['atk1'] == 269 or $pok['atk2'] == 269 or $pok['atk3'] == 269 or $pok['atk4'] == 269)) {
    $n_nom = 853;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 810 and $pok['lvl'] >= 16) {
    $n_nom = 811;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 811 and $pok['lvl'] >= 35) {
    $n_nom = 812;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 813 and $pok['lvl'] >= 16) {
    $n_nom = 814;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 814 and $pok['lvl'] >= 35) {
    $n_nom = 815;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 816 and $pok['lvl'] >= 16) {
    $n_nom = 817;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 817 and $pok['lvl'] >= 35) {
    $n_nom = 818;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 819 and $pok['lvl'] >= 24) {
    $n_nom = 820;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 821 and $pok['lvl'] >= 18) {
    $n_nom = 822;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 822 and $pok['lvl'] >= 38) {
    $n_nom = 823;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 824 and $pok['lvl'] >= 10) {
    $n_nom = 825;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 825 and $pok['lvl'] >= 30) {
    $n_nom = 826;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 827 and $pok['lvl'] >= 18) {
    $n_nom = 828;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 829 and $pok['lvl'] >= 20) {
    $n_nom = 830;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 831 and $pok['lvl'] >= 24) {
    $n_nom = 832;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 833 and $pok['lvl'] >= 22) {
    $n_nom = 834;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 835 and $pok['lvl'] >= 25) {
    $n_nom = 836;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 837 and $pok['lvl'] >= 18) {
    $n_nom = 838;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 838 and $pok['lvl'] >= 34) {
    $n_nom = 839;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 843 and $pok['lvl'] >= 36) {
    $n_nom = 844;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 846 and $pok['lvl'] >= 126) {
    $n_nom = 847;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 850 and $pok['lvl'] >= 28) {
    $n_nom = 851;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 856 and $pok['lvl'] >= 32) {
    $n_nom = 857;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 857 and $pok['lvl'] >= 42) {
    $n_nom = 858;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 859 and $pok['lvl'] >= 32) {
    $n_nom = 860;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 860 and $pok['lvl'] >= 42) {
    $n_nom = 861;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 872 and $pok['spark'] == 0) {
    $n_nom = 873;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 878 and $pok['lvl'] >= 34) {
    $n_nom = 879;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 885 and $pok['lvl'] >= 50) {
    $n_nom = 886;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 886 and $pok['lvl'] >= 60) {
    $n_nom = 887;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
  ...
  if ($pok['basenum'] == 458 and $pok['lvl'] >= 20) {
    $n_nom = 226;
    $pdex = $mysqli->query("SELECT name FROM `base_pokemon` WHERE `id` = '$n_nom'")->fetch_assoc();
    $mysqli->query("UPDATE user_pokemons SET `basenum` = '$n_nom',`numbpu` = '$n_nom',`name`='" . $pdex['name'] . "' WHERE id='" . $pok['id'] . "'");
    stat_updates($pok['id']);
