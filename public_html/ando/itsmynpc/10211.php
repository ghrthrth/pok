...
$nameNPC = 'Секретарь Психического стадиона';
$tur = 1;
if($user['id'] == 1 or $user['id'] == 75){
if($npc == 10211){ }else{  die("<script>parent._location.location='game.php?fun=m_location&map=1';</script>"); }
if($tur == 0){
if(empty($answer)){
$textNPC = 'Привет!';
}
...
if(array_key_exists('go',$_GET)) {
	...
	$mysqli->query("UPDATE users SET location = '73', arena = '200' WHERE `id` = '".$_SESSION['user_id']."'");
