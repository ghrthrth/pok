...
<TD width='300'><b>Деактивация:</b><BR><UL class='pokelist'>
...
?>
<li><a href='game.php?fun=m_npc&npc_id=8&answ_id=2&map=1&TPI_id=<?=$off['id'];?>'>#<?php  print numbPok($off['basenum']).' '.$pokname;?></a>&nbsp;&nbsp;&nbsp;<span style='color:#82b1e2; font-size:9px'>ID <?=$off['id'];?></span><BR>
<?php  } ?>
</OL></TD>
<?php  if(!empty($_GET['TPI_id'])){ 
	...
	elseif($zapros['type'] == 'showy') {$type = 'poketitleshowy'; $img = 'shine';$name = 'snowy';}?>
	<td align="center" width="500">
       <div style="height:240; overflow:hidden">
       <table border="0" class="nonBorder" cellpadding="3" cellspacing="1" width="500">
       <tbody><tr><td class="title" align="center">
         <span class="<?=$type;?>"><a href="javascript:" onclick="win1=window.open(&quot;pokedex.php?sp_id=<?=numbPok($zapros['basenum']);?>&quot;,&quot;dex&quot;,&quot;width=600,height=600,scrollbars=yes&quot;);"><img src="img/pokedex.gif" alt="Покедекс" title="Покедекс" border="0"></a>#<?php  print numbPok($zapros['basenum']).' '.$pokname.' '.$zapros['lvl'].'-lvl'.' '.$name;?> <?php if($zapros['trn'] > 0){ ?><img src='./img/trn/Tren_ar<?=$zapros["trn"];?>.png'><?php } ?></span>
         </td></tr><tr><td>
