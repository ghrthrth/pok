...
items[1][0]=1;
items[1][1]=53;
items[1][2]='X Точность';
items[1][3]=20000;
items[1][4]=-1;
items[1][5] = new Image(32,32);
items[1][5].src='img/items/53.gif';
items[2] = new Array(5);
items[2][0]=2;
items[2][1]=54;
items[2][2]='X Атака';
...
items[2][5].src='img/items/54.gif';
items[3] = new Array(5);
items[3][0]=5;
items[3][1]=55;
items[3][2]='X Защита';
...
items[3][5].src='img/items/55.gif';
items[4] = new Array(5);
items[4][0]=6;
items[4][1]=56;
items[4][2]='X Спец Защита';
items[4][3]=20000;
items[4][4]=-1;
items[4][5] = new Image(32,32);
items[4][5].src='img/items/56.gif';
items[5] = new Array(5);
items[5][0]=7;
items[5][1]=57;
items[5][2]='X Спец Атака';
items[5][3]=20000;
items[5][4]=-1;
items[5][5] = new Image(32,32);
items[5][5].src='img/items/57.gif';
items[6] = new Array(5);
items[6][0]=8;
items[6][1]=58;
items[6][2]='X Скорость';
items[6][3]=20000;
items[6][4]=-1;
items[6][5] = new Image(32,32);
items[6][5].src='img/items/58.gif';
...
<input type="button" value=">>" style="width:70" onclick="buys[document.buy.sellID.value]=buys[document.buy.sellID.value]*1+Math.round(document.buy.amount.value*1); load_buy_list();">
  ...
  <P>
  <div align="right">
  <form name=FormBuy action=game.php?fun=m_npc&npc_id=37&answ_id=1 method=post>
...
<?php 	}else{
	...
	function price_item($itm){
		if($itm == 53) { $prc = 20000; }else
		if($itm == 54) { $prc = 20000; }else
		if($itm == 55) { $prc = 20000; }else
		if($itm == 56) { $prc = 20000; }else
		if($itm == 57) { $prc = 20000; }else
		if($itm == 58) { $prc = 20000; }else{
        return 0;
		}
		return $prc;
	}
