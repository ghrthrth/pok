...
if($npc == 228 && $answer == 3){ 
	if(array_key_exists('p_id',$_GET)){
		...
		if(!item_isset(1, 250000)){
			echo "<SCRIPT>location.href='game.php?fun=m_npc&npc_id=228&answ_id=3&map=1';</SCRIPT>"; return;
		}else{
...
<a href="game.php?fun=m_location&map=1"><< уйти</a><P>
	...
	?>
    	 <tr class='bottom_dot'>
    	  ...
    	  <td><a href='game.php?fun=m_npc&npc_id=228&answ_id=3&map=1&p_id=<?=$pok['id'];?>'>Вернуть >></a></td>
    	 </tr>
		 <?php 
		}?>
    	</table>	
