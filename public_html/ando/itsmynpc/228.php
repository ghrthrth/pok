...
}elseif($npc == 228 && $answer == 1 /*&& $npcloc['location'] != $user['location']*/){
...
}elseif($npc == 228 && $answer == 2 /*&& $npcloc['location'] != $user['location']*/){
	include ("228_1.php");
	die();
}elseif($npc == 228 && $answer == 3 /*&& $npcloc['location'] != $user['location']*/){
	#Возврат покемонов
	include ("228_2.php");
	die();
}elseif($npc == 228 && $answer == 4 /*&& $npcloc['location'] != $user['location']*/){
