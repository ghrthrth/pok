...
if(info_quest(500,'step') == 2){
		$inCatchPok = $mysqli->query("select * from `base_pokemon` WHERE `id`='210' LIMIT 1")->fetch_assoc();
		...
		$mysqli->query("INSERT INTO pokem_vs (basenum,name,lvl,hp,hp_max,attack,def,speed,sp_attack,sp_def,har,type,gender,atk1,atk2,money,item,catch ) VALUES('210','Granbull','$lvl','$hp','$hp','$atk','$def','$speed','$satk','$sdef','$harR','snowy','1','$atk1','$atk2','300','269','1')"); 
