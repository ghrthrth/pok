...
}else*/if($npc == 150 && empty($answer)){
	$textNPC = 'Покемоны будут не доступны для разведения после вылупления!.';
	$info1 = $mysqli->query("SELECT * FROM user_items WHERE `user_id` = '".$user_id."' and `item_id` = '446'")->fetch_assoc();
	...
	if(array_key_exists('sellID',$_POST) and $_POST['sellID'] > 0){
		...
		if(array_key_exists('kr',$_POST)){
          ...
          if($sl <= $info1['count']){
          	...
          	minus_item($sl,446,$user_id);
          	echo "Яйцо успешно преобретено!";
          	return;
          }else{
          	echo "Не достаточно посыпушек!";
          	return;
          }
		}
	}
...
<td width="300">
  ...
  <td class="bottom_dot">Яйцо Oricorio</td><td align="right" width="150" class="bottom_dot">20 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Drilbur</td><td align="right" width="150" class="bottom_dot">20 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Axew</td><td align="right" width="150" class="bottom_dot">30 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Wimpod</td><td align="right" width="150" class="bottom_dot">200 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Flabebe</td><td align="right" width="150" class="bottom_dot">50 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Sandygast</td><td align="right" width="150" class="bottom_dot">50 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Munchlax</td><td align="right" width="150" class="bottom_dot">100 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Poipole</td><td align="right" width="150" class="bottom_dot">300 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Archen</td><td align="right" width="150" class="bottom_dot">200 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Meltan</td><td align="right" width="150" class="bottom_dot">200 пспш.</td>
  </tr>
  ...
  <td class="bottom_dot">Яйцо Solgaleo</td><td align="right" width="150" class="bottom_dot">500 пспш.</td>
  </tr>
...
<form name='FormBuy' action='game.php?fun=m_npc&npc_id=150' method='post'>
