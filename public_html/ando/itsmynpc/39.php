...
items[1][0]=1;
items[1][1]=131;
items[1][2]='Огненный камень';
items[1][3]=120000;
items[1][4]=-1;
items[1][5] = new Image(32,32);
items[1][5].src='img/items/131.gif';
items[2] = new Array(5);
items[2][0]=2;
items[2][1]=132;
items[2][2]='Водный камень';
items[2][3]=500000;
items[2][4]=-1;
items[2][5] = new Image(32,32);
items[2][5].src='img/items/132.gif';
items[3] = new Array(5);
items[3][0]=5;
items[3][1]=133;
items[3][2]='Лиственный камень';
items[3][3]=300000;
items[3][4]=-1;
items[3][5] = new Image(32,32);
items[3][5].src='img/items/133.gif';
items[4] = new Array(5);
items[4][0]=6;
items[4][1]=134;
items[4][2]='Громовой камень';
items[4][3]=150000;
items[4][4]=-1;
items[4][5] = new Image(32,32);
items[4][5].src='img/items/134.gif';
items[5] = new Array(5);
items[5][0]=7;
items[5][1]=135;
items[5][2]='Лунный камень';
items[5][3]=250000;
items[5][4]=-1;
items[5][5] = new Image(32,32);
items[5][5].src='img/items/135.gif';
items[6] = new Array(5);
items[6][0]=8;
items[6][1]=136;
items[6][2]='Солнечный камень';
items[6][3]=300000;
items[6][4]=-1;
items[6][5] = new Image(32,32);
items[6][5].src='img/items/136.gif';

sell_items_amount=6;currency_txt=' кр.';   buys = new Array(sell_items_amount);
...
<input type="button" value=">>" style="width:70" onclick="buys[document.buy.sellID.value]=buys[document.buy.sellID.value]*1+Math.round(document.buy.amount.value*1); load_buy_list();">
  ...
  <P>
  <div align="right">
  <form name=FormBuy action=game.php?fun=m_npc&npc_id=39&answ_id=1 method=post>
...
<?php   }else{
  ...
  function price_item($itm){
    if($itm == 131) { $prc = 120000; }else
    if($itm == 132) { $prc = 500000; }else
    if($itm == 133) { $prc = 300000; }else
    if($itm == 134) { $prc = 150000; }else
    if($itm == 135) { $prc = 250000; }else
    if($itm == 136) { $prc = 300000; }else{
        return 0;
    }
    return $prc;
  }
