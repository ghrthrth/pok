...
items[1][1]=330;                             // ID предмета
items[1][2]='Набор Тренировки';  //Название предмета. Совпадает ли оно с БД не важно, как здесь напишешь так и будет
items[1][3]=1;                   //Цена
items[1][4]=-1;                  // Доступное количество. -1 это бесконечные.
items[1][5] = new Image(32,32);  // Размер картинки
items[1][5].src='img/items/330.gif';  //Здесь пиши ID предмета. Так будет показан его картинка.
items[2] = new Array(5);
items[2][0]=2;
items[2][1]=101;
items[2][2]='Тюбик с краской';
items[2][3]=1;
items[2][4]=-1;
items[2][5] = new Image(32,32);
items[2][5].src='img/items/101.gif';
items[3] = new Array(5);
items[3][0]=5;
items[3][1]=72;
items[3][2]='Даркбол';
...
items[3][5].src='img/items/72.gif';
items[4] = new Array(5);
items[4][0]=6;
items[4][1]=62;
items[4][2]='Мастерболл';
items[4][3]=1;
items[4][4]=-1;
items[4][5] = new Image(32,32);
items[4][5].src='img/items/62.gif';
items[5] = new Array(5);
items[5][0]=7;
items[5][1]=1055;
items[5][2]='Набор витамин';
items[5][3]=5;
items[5][4]=-1;
items[5][5] = new Image(32,32);
items[5][5].src='img/items/1055.gif';
items[6] = new Array(5);
items[6][0]=8;
items[6][1]=1026;
items[6][2]='Набор ослабления';
items[6][3]=1;
items[6][4]=-1;
items[6][5] = new Image(32,32);
items[6][5].src='img/items/1026.gif';
items[7] = new Array(5);
items[7][0]=9;
items[7][1]=309;
items[7][2]='Ванильная конфета';
items[7][3]=1;
items[7][4]=-1;
items[7][5] = new Image(32,32);
items[7][5].src='img/items/309.gif';
items[8] = new Array(5);
items[8][0]=10;
items[8][1]=1053;
items[8][2]='Случайная карта';
items[8][3]=1;
items[8][4]=-1;
items[8][5] = new Image(32,32);
items[8][5].src='img/items/1053.gif';
items[9] = new Array(5);
items[9][0]=11;
items[9][1]=42;
items[9][2]='Скобовое кольцо';
items[9][3]=5;
items[9][4]=-1;
items[9][5] = new Image(32,32);
items[9][5].src='img/items/42.gif';
items[10] = new Array(5);
items[10][0]=12;
items[10][1]=179;
items[10][2]='Сладкая ягода';
items[10][3]=3;
items[10][4]=-1;
items[10][5] = new Image(32,32);
items[10][5].src='img/items/179.gif';
items[11] = new Array(5);
items[11][0]=13;
items[11][1]=384;
items[11][2]='Секретный ключ ';
items[11][3]=10;
items[11][4]=-1;
items[11][5] = new Image(32,32);
items[11][5].src='img/items/384.gif';
...
<input type="button" value=">>" style="width:70" onclick="buys[document.buy.sellID.value]=buys[document.buy.sellID.value]*1+Math.round(document.buy.amount.value*1); load_buy_list();">
  ...
  <P>
  <div align="right">
  <form name=FormBuy action=game.php?fun=m_npc&npc_id=180&answ_id=1 method=post>
