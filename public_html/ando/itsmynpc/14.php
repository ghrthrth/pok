...
<input type="button" value=">>" style="width:70" onclick="buys[document.buy.sellID.value]=buys[document.buy.sellID.value]*1+Math.round(document.buy.amount.value*1); load_buy_list();">
  ...
  <P>
  <div align="right">
  <form name=FormBuy action=game.php?fun=m_npc&npc_id=14&answ_id=1 method=post>
...
<?php    }else{
  $info = $mysqli->query("SELECT * FROM user_items WHERE `user_id` = '".$user_id."' and `item_id` = '1'")->fetch_assoc();
    function price_item($itm) {
             if ($itm == 38) { $prc = 150; }
        else if ($itm == 50) { $prc = 500; }
        else if ($itm == 51) { $prc = 900; }
        else if ($itm == 29) { $prc = 4000; }
        else if ($itm == 3)  { $prc = 1000; }
        else if ($itm == 4)  { $prc = 1000; }
        else if ($itm == 9)  { $prc = 1000; }
        else if ($itm == 13) { $prc = 1000; }
        else if ($itm == 36) { $prc = 1000; }
        else if ($itm == 15) { $prc = 400; }
        else if ($itm == 16) { $prc = 650; }
        else if ($itm == 17) { $prc = 1500; }
        else if ($itm == 60) { $prc = 50; }
        else if ($itm == 61) { $prc = 500; }
        else if ($itm == 63) { $prc = 900; }
        else if ($itm == 64) { $prc = 300; }
        else if ($itm == 65) { $prc = 400; }
        else if ($itm == 66) { $prc = 600; }
        else if ($itm == 67) { $prc = 150; }
        else if ($itm == 68) { $prc = 300; }
        else if ($itm == 69) { $prc = 250; }
        else if ($itm == 168) { $prc = 400000; }
        else { return 0; }
    return $prc;
  }
