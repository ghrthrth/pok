...
}elseif($npc == 74 && $answer == 1 && $npcloc['location'] != $user['location']){
...
}elseif($npc == 74 && $answer == 2 && $npcloc['location'] != $user['location']){
	include_once ("8_1.php");
	die();
}elseif($npc == 74 && $answer == 3 && $npcloc['location'] != $user['location']){
	#Возврат покемонов
	include_once ("8_2.php");
	die();
}elseif($npc == 74 && $answer == 4 && $npcloc['location'] != $user['location']){
