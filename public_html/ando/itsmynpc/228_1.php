...
elseif($zapros['gender'] == 'female' ) $sex = '1' ;
	...
	<b><a href="game.php?fun=p_base&amp;map=1&amp;type=extract&amp;TP_id=<?=$id;?>">&lt;Активировать&gt;</a></b></td>s
<?php }?>
<?php  }else{
