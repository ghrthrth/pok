...
$nameNPC = 'Интендант';
$baseloc['name'] = false;
if($npc == 179 && empty($answer)){
$info = $mysqli->query("SELECT * FROM user_items WHERE `user_id` = '".$user_id."' and `item_id` = '1088'")->fetch_assoc();
?>
<html>
  <head>
...
items[1][0]=1;
items[1][1]=1012;
items[1][2]='TM 12 - Taunt';
items[1][3]=50;
items[1][4]=-1;
items[1][5] = new Image(32,32);
items[1][5].src='img/items/1012.gif';
items[2] = new Array(5);
items[2][0]=2;
items[2][1]=1002;
items[2][2]='TM 30 - Shadow Ball';
items[2][3]=50;
items[2][4]=-1;
items[2][5] = new Image(32,32);
items[2][5].src='img/items/1002.gif';
items[3] = new Array(5);
items[3][0]=5;
items[3][1]=1025;
items[3][2]='TM 19 - Giga Drain';
items[3][3]=50;
items[3][4]=-1;
items[3][5] = new Image(32,32);
items[3][5].src='img/items/1025.gif';
items[4] = new Array(5);
items[4][0]=6;
items[4][1]=1019;
items[4][2]='TM 26 - Earthquake';
items[4][3]=75;
items[4][4]=-1;
items[4][5] = new Image(32,32);
items[4][5].src='img/items/1019.gif';
items[5] = new Array(5);
items[5][0]=7;
items[5][1]=1036;
items[5][2]='TM 13 - Ice Beam';
items[5][3]=75;
items[5][4]=-1;
items[5][5] = new Image(32,32);
items[5][5].src='img/items/1036.gif';
items[6] = new Array(5);
items[6][0]=8;
items[6][1]=1050;
items[6][2]='TM 24 - Thunderbolt';
items[6][3]=75;
items[6][4]=-1;
items[6][5] = new Image(32,32);
items[6][5].src='img/items/1050.gif';
items[7] = new Array(5);
items[7][0]=9;
items[7][1]=1006;
items[7][2]='TM 35 - Flamethrower';
items[7][3]=75;
items[7][4]=-1;
items[7][5] = new Image(32,32);
items[7][5].src='img/items/1006.gif';
items[8] = new Array(5);
items[8][0]=10;
items[8][1]=1003;
items[8][2]='TM 44 - Rest';
items[8][3]=100;
items[8][4]=-1;
items[8][5] = new Image(32,32);
items[8][5].src='img/items/1003.gif';
items[9] = new Array(5);
items[9][0]=11;
items[9][1]=1011;
...
items[9][5].src='img/items/1011.gif';
items[10] = new Array(5);
items[10][0]=12;
items[10][1]=1009;
items[10][2]='TM 8 - Bulk Up';
items[10][3]=100;
items[10][4]=-1;
items[10][5] = new Image(32,32);
items[10][5].src='img/items/1009.gif';
items[11] = new Array(5);
items[11][0]=13;
items[11][1]=1010;
items[11][2]='TM 4 - Calm Mind';
items[11][3]=100;
items[11][4]=-1;
items[11][5] = new Image(32,32);
items[11][5].src='img/items/1010.gif';




sell_items_amount=11;currency_txt=' вбшр.';   buys = new Array(sell_items_amount);
...
<span id=txt>
<h1>Интендант</h1>
<div><big><b>Ваш баланс: <?=price($info['count']);?> Ваббашаров</b></big></div><TABLE border=0><TR valign=top><TD width=300>
...
<input type="button" value=">>" style="width:70" onclick="buys[document.buy.sellID.value]=buys[document.buy.sellID.value]*1+Math.round(document.buy.amount.value*1); load_buy_list();">
  ...
  <P>
  <div align="right">
  <form name=FormBuy action=game.php?fun=m_npc&npc_id=179&answ_id=1 method=post>
...
<?php    }else{
  $info = $mysqli->query("SELECT * FROM user_items WHERE `user_id` = '".$user_id."' and `item_id` = '1088'")->fetch_assoc();
    function price_item($itm) { //цены
             if ($itm == 1012) { $prc = 50; }
        else if ($itm == 1002) { $prc = 50; }
        else if ($itm == 1025) { $prc = 50; }
        else if ($itm == 1019) { $prc = 75; }
        else if ($itm == 1036) { $prc = 75; }
        else if ($itm == 1050) { $prc = 75; }
        else if ($itm == 1006) { $prc = 75; }
        else if ($itm == 1003) { $prc = 100; }
        else if ($itm == 1011) { $prc = 100; }
        else if ($itm == 1009) { $prc = 100; }
        else if ($itm == 1010) { $prc = 100; }
        else { return 0; }
    return $prc;
  }
